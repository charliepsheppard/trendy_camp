...
spot1 = Spot.create({
  ...
  category: 'Tent',
  price: 55,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/fern-gully.jpg?tr=w-800'
})
...
spot2 = Spot.create({
  ...
  price: 200,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/blueberry-hill.jpg?tr=w-800'
})
...
spot3 = Spot.create({
  ...
  category: 'Tent',
  price: 30,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/north-fork.jpg?tr=w-800'
})
...
spot4 = Spot.create({
  ...
  category: 'Cabin',
  price: 35,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/hoh-cabin.jpg?tr=w-800'
})
...
spot5 = Spot.create({
  ...
  category: 'Tent' ,
  price: 65,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/skycamp.jpg?tr=w-800'
})
...
spot6 = Spot.create({
  ...
  category: 'Vacation rental',
  price: 600,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/magic-hour.jpg?tr=w-800'
})
...
spot7 = Spot.create({
  ...
  price: 99,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/saharan.jpg?tr=w-800'
})
...
spot8 = Spot.create({
  ...
  category: 'Tent',
  price: 48,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/watering-hole.jpg?tr=w-800'
})
...
spot9 = Spot.create({
  ...
  category: 'Yurt',
  price: 222,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/castle-house.jpg?tr=w-800'
})
...
spot10 = Spot.create({
  ...
  category: 'Tent',
  price: 263,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/yellowstone-dreamin.jpg?tr=w-800'
})
...
spot11 = Spot.create({
  ...
  category: 'RV',
  price: 85,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/sportsman-retreat.jpg?tr=w-800'
})
...
spot12 = Spot.create({
  ...
  category: 'Cabin',
  price: 160,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/arcadia-cabin.jpg?tr=w-800'
})
...
spot13 = Spot.create({
  ...
  category: 'RV',
  price: 25,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/desert-moon.jpg?tr=w-800'
})
...
spot14 = Spot.create({
  ...
  category: 'Canvas tent',
  price: 95,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/sky-dancers.jpg?tr=w-800'
})
...
spot15 = Spot.create({
  ...
  category: 'Tent',
  price: 20,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/north-campground.jpg?tr=w-800'
})
...
spot16 = Spot.create({
  ...
  category: 'Cabin',
  price: 105,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/sheep-camp.jpg?tr=w-800'
})
...
spot17 = Spot.create({
  ...
  category: 'Cabin',
  price: 215,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/apple-hollow.jpg?tr=w-800'
})
...
spot18 = Spot.create({
  ...
  category: 'Yurt',
  price: 130,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/yurt-stargazing.jpg?tr=w-800'
})
...
spot19 = Spot.create({
  ...
  category: 'Cabin',
  price: 135,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/zen-house.jpg?tr=w-800'
})
...
spot20 = Spot.create({
  ...
  category: 'Cabin',
  price: 85,
  photo: 'https://ik.imagekit.io/4hr81t1ot/trendy-camp/hobbit-house.jpg?tr=w-800'
})
